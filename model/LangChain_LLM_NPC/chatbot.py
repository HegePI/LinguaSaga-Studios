...
def main():
    # Temporary interface
    st.set_page_config(page_title="Cyberpunk NPCs ChatBot",
                       page_icon=":NPC:")
    ...
    user_input = st.text_input("Hi, V I am Johnny Silverhand, What questions do you have?: ")
    if user_input:
        process_user_input(user_input)

    with st.sidebar:
        st.subheader("NPC`s background stories")
        files = st.file_uploader("Input background stories",
